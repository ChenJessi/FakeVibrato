...
public class PagerGridLayoutManager extends RecyclerView.LayoutManager
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        MyLog.i("Item onLayoutChildren");
        MyLog.i("Item onLayoutChildren isPreLayout = " + state.isPreLayout());
        MyLog.i("Item onLayoutChildren isMeasuring = " + state.isMeasuring());
        MyLog.i("Item onLayoutChildren state = " + state);
    ...
    private void recycleAndFillItems(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        MyLog.i("mOffsetX = " + mOffsetX);
        MyLog.i("mOffsetY = " + mOffsetY);
        ...
        MyLog.e("startPos = " + startPos);
        MyLog.e("stopPos = " + stopPos);
        ...
        MyLog.e("child count = " + getChildCount());
    }
    ...
    public void onScrollStateChanged(int state) {
        MyLog.i("onScrollStateChanged = " + state);
        mScrollState = state;
    ...
    private Rect getItemFrameByPosition(int pos) {
        ...
        if (null == rect) {
            ...
            // 状态输出，用于调试
            MyLog.i("pagePos = " + pagePos);
            MyLog.i("行 = " + row);
            MyLog.i("列 = " + col);

            MyLog.i("offsetX = " + offsetX);
            MyLog.i("offsetY = " + offsetY);
    ...
    private int getPageIndexByOffset() {
        ...
        MyLog.i("getPageIndexByOffset pageIndex = " + pageIndex);
        return pageIndex;
    }
    ...
    int findNextPageFirstPos() {
        ...
        MyLog.e("computeScrollVectorForPosition next = " + page);
    ...
    int findPrePageFirstPos() {
        ...
        int page = mLastPageIndex;
        page--;
        MyLog.e("computeScrollVectorForPosition pre = " + page);
        if (page < 0) {
            page = 0;
        }
        MyLog.e("computeScrollVectorForPosition pre = " + page);
    ...
    private void setPageIndex(int pageIndex, boolean isScrolling) {
        MyLog.e("setPageIndex = " + pageIndex + ":" + isScrolling);
    ...
    public void scrollToPage(int pageIndex) {
        ...
        MyLog.e("mTargetOffsetXBy = " + mTargetOffsetXBy);
        MyLog.e("mTargetOffsetYBy = " + mTargetOffsetYBy);
