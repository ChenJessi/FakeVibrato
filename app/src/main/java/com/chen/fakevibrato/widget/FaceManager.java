...
public class FaceManager implements IQMUIQQFaceManager {
    private static final HashMap<String, Integer> sFaceMap = new HashMap<>();
    private static final List<QQFace> mFaceList = new ArrayList<>();
    private static final SparseIntArray sEmojisMap = new SparseIntArray(846);
    private static final SparseIntArray sSoftbanksMap = new SparseIntArray(471);
    @SuppressWarnings("MismatchedQueryAndUpdateOfCollection")
    private static final ArrayMap<String, String> mFaceFileNameList = new ArrayMap<>();//存储QQ表情对应的文件名,方便混淆后可以获取到原文件名
    ...
    static {
        ...
        mFaceList.add(new QQFace("[微笑]", R.drawable.smiley_0));
        mFaceList.add(new QQFace("[撇嘴]", R.drawable.smiley_1));
        mFaceList.add(new QQFace("[色]", R.drawable.smiley_2));
        mFaceList.add(new QQFace("[发呆]", R.drawable.smiley_3));
        mFaceList.add(new QQFace("[得意]", R.drawable.smiley_4));
        mFaceList.add(new QQFace("[流泪]", R.drawable.smiley_5));
        mFaceList.add(new QQFace("[害羞]", R.drawable.smiley_6));
        mFaceList.add(new QQFace("[闭嘴]", R.drawable.smiley_7));
        mFaceList.add(new QQFace("[睡]", R.drawable.smiley_8));
        mFaceList.add(new QQFace("[大哭]", R.drawable.smiley_9));
        mFaceList.add(new QQFace("[尴尬]", R.drawable.smiley_10));
        mFaceList.add(new QQFace("[发怒]", R.drawable.smiley_11));
        mFaceList.add(new QQFace("[调皮]", R.drawable.smiley_12));
        mFaceList.add(new QQFace("[呲牙]", R.drawable.smiley_13));
        mFaceList.add(new QQFace("[惊讶]", R.drawable.smiley_14));
        mFaceList.add(new QQFace("[难过]", R.drawable.smiley_15));
        mFaceList.add(new QQFace("[酷]", R.drawable.smiley_16));
        mFaceList.add(new QQFace("[冷汗]", R.drawable.smiley_17));
        mFaceList.add(new QQFace("[抓狂]", R.drawable.smiley_18));
        mFaceList.add(new QQFace("[吐]", R.drawable.smiley_19));
        mFaceList.add(new QQFace("[偷笑]", R.drawable.smiley_20));
        mFaceList.add(new QQFace("[可爱]", R.drawable.smiley_21));
        mFaceList.add(new QQFace("[白眼]", R.drawable.smiley_22));
        mFaceList.add(new QQFace("[傲慢]", R.drawable.smiley_23));
        mFaceList.add(new QQFace("[饥饿]", R.drawable.smiley_24));
        mFaceList.add(new QQFace("[困]", R.drawable.smiley_25));
        mFaceList.add(new QQFace("[惊恐]", R.drawable.smiley_26));
        mFaceList.add(new QQFace("[流汗]", R.drawable.smiley_27));
        mFaceList.add(new QQFace("[憨笑]", R.drawable.smiley_28));
        mFaceList.add(new QQFace("[大兵]", R.drawable.smiley_29));
        mFaceList.add(new QQFace("[奋斗]", R.drawable.smiley_30));
        mFaceList.add(new QQFace("[咒骂]", R.drawable.smiley_31));
        mFaceList.add(new QQFace("[疑问]", R.drawable.smiley_32));
        mFaceList.add(new QQFace("[嘘]", R.drawable.smiley_33));
        mFaceList.add(new QQFace("[晕]", R.drawable.smiley_34));
        mFaceList.add(new QQFace("[折磨]", R.drawable.smiley_35));
        mFaceList.add(new QQFace("[衰]", R.drawable.smiley_36));
        mFaceList.add(new QQFace("[骷髅]", R.drawable.smiley_37));
        mFaceList.add(new QQFace("[敲打]", R.drawable.smiley_38));
        mFaceList.add(new QQFace("[再见]", R.drawable.smiley_39));
        mFaceList.add(new QQFace("[擦汗]", R.drawable.smiley_40));
        mFaceList.add(new QQFace("[抠鼻]", R.drawable.smiley_41));
        mFaceList.add(new QQFace("[鼓掌]", R.drawable.smiley_42));
        mFaceList.add(new QQFace("[糗大了]", R.drawable.smiley_43));
        mFaceList.add(new QQFace("[坏笑]", R.drawable.smiley_44));
        mFaceList.add(new QQFace("[左哼哼]", R.drawable.smiley_45));
        mFaceList.add(new QQFace("[右哼哼]", R.drawable.smiley_46));
        mFaceList.add(new QQFace("[哈欠]", R.drawable.smiley_47));
        mFaceList.add(new QQFace("[鄙视]", R.drawable.smiley_48));
        mFaceList.add(new QQFace("[委屈]", R.drawable.smiley_49));
        mFaceList.add(new QQFace("[快哭了]", R.drawable.smiley_50));
        mFaceList.add(new QQFace("[阴险]", R.drawable.smiley_51));
        mFaceList.add(new QQFace("[亲亲]", R.drawable.smiley_52));
        mFaceList.add(new QQFace("[吓]", R.drawable.smiley_53));
        mFaceList.add(new QQFace("[可怜]", R.drawable.smiley_54));
        mFaceList.add(new QQFace("[菜刀]", R.drawable.smiley_55));
        mFaceList.add(new QQFace("[西瓜]", R.drawable.smiley_56));
        mFaceList.add(new QQFace("[啤酒]", R.drawable.smiley_57));
        mFaceList.add(new QQFace("[篮球]", R.drawable.smiley_58));
        mFaceList.add(new QQFace("[乒乓]", R.drawable.smiley_59));
        mFaceList.add(new QQFace("[咖啡]", R.drawable.smiley_60));
        mFaceList.add(new QQFace("[饭]", R.drawable.smiley_61));
        mFaceList.add(new QQFace("[猪头]", R.drawable.smiley_62));
        mFaceList.add(new QQFace("[玫瑰]", R.drawable.smiley_63));
        mFaceList.add(new QQFace("[凋谢]", R.drawable.smiley_64));
        mFaceList.add(new QQFace("[示爱]", R.drawable.smiley_65));
        mFaceList.add(new QQFace("[爱心]", R.drawable.smiley_66));
        mFaceList.add(new QQFace("[心碎]", R.drawable.smiley_67));
        mFaceList.add(new QQFace("[蛋糕]", R.drawable.smiley_68));
        mFaceList.add(new QQFace("[闪电]", R.drawable.smiley_69));
        mFaceList.add(new QQFace("[炸弹]", R.drawable.smiley_70));
        mFaceList.add(new QQFace("[刀]", R.drawable.smiley_71));
        mFaceList.add(new QQFace("[足球]", R.drawable.smiley_72));
        mFaceList.add(new QQFace("[瓢虫]", R.drawable.smiley_73));
        mFaceList.add(new QQFace("[便便]", R.drawable.smiley_74));
        mFaceList.add(new QQFace("[月亮]", R.drawable.smiley_75));
        mFaceList.add(new QQFace("[太阳]", R.drawable.smiley_76));
        mFaceList.add(new QQFace("[礼物]", R.drawable.smiley_77));
        mFaceList.add(new QQFace("[拥抱]", R.drawable.smiley_78));
        mFaceList.add(new QQFace("[强]", R.drawable.smiley_79));
        mFaceList.add(new QQFace("[弱]", R.drawable.smiley_80));
        mFaceList.add(new QQFace("[握手]", R.drawable.smiley_81));
        mFaceList.add(new QQFace("[胜利]", R.drawable.smiley_82));
        mFaceList.add(new QQFace("[抱拳]", R.drawable.smiley_83));
        mFaceList.add(new QQFace("[勾引]", R.drawable.smiley_84));
        mFaceList.add(new QQFace("[拳头]", R.drawable.smiley_85));
        mFaceList.add(new QQFace("[差劲]", R.drawable.smiley_86));
        mFaceList.add(new QQFace("[爱你]", R.drawable.smiley_87));
        mFaceList.add(new QQFace("[NO]", R.drawable.smiley_88));
        mFaceList.add(new QQFace("[OK]", R.drawable.smiley_89));
        mFaceList.add(new QQFace("[爱情]", R.drawable.smiley_90));
        mFaceList.add(new QQFace("[飞吻]", R.drawable.smiley_91));
        mFaceList.add(new QQFace("[跳跳]", R.drawable.smiley_92));
        mFaceList.add(new QQFace("[发抖]", R.drawable.smiley_93));
        mFaceList.add(new QQFace("[怄火]", R.drawable.smiley_94));
        mFaceList.add(new QQFace("[转圈]", R.drawable.smiley_95));
        mFaceList.add(new QQFace("[磕头]", R.drawable.smiley_96));
        mFaceList.add(new QQFace("[回头]", R.drawable.smiley_97));
        mFaceList.add(new QQFace("[跳绳]", R.drawable.smiley_98));
        mFaceList.add(new QQFace("[挥手]", R.drawable.smiley_99));
        mFaceList.add(new QQFace("[激动]", R.drawable.smiley_100));
        mFaceList.add(new QQFace("[街舞]", R.drawable.smiley_101));
        mFaceList.add(new QQFace("[献吻]", R.drawable.smiley_102));
        mFaceList.add(new QQFace("[左太极]", R.drawable.smiley_103));
        mFaceList.add(new QQFace("[右太极]", R.drawable.smiley_104));

        for (QQFace face : mFaceList) {
            sFaceMap.put(face.getName(), face.getRes());
        }

        mFaceFileNameList.put("[微笑]", "smiley_0");
        mFaceFileNameList.put("[撇嘴]", "smiley_1");
        mFaceFileNameList.put("[色]", "smiley_2");
        mFaceFileNameList.put("[发呆]", "smiley_3");
        mFaceFileNameList.put("[得意]", "smiley_4");
        mFaceFileNameList.put("[流泪]", "smiley_5");
        mFaceFileNameList.put("[害羞]", "smiley_6");
        mFaceFileNameList.put("[闭嘴]", "smiley_7");
        mFaceFileNameList.put("[睡]", "smiley_8");
        mFaceFileNameList.put("[大哭]", "smiley_9");
        mFaceFileNameList.put("[尴尬]", "smiley_10");
        mFaceFileNameList.put("[发怒]", "smiley_11");
        mFaceFileNameList.put("[调皮]", "smiley_12");
        mFaceFileNameList.put("[呲牙]", "smiley_13");
        mFaceFileNameList.put("[惊讶]", "smiley_14");
        mFaceFileNameList.put("[难过]", "smiley_15");
        mFaceFileNameList.put("[酷]", "smiley_16");
        mFaceFileNameList.put("[冷汗]", "smiley_17");
        mFaceFileNameList.put("[抓狂]", "smiley_18");
        mFaceFileNameList.put("[吐]", "smiley_19");
        mFaceFileNameList.put("[偷笑]", "smiley_20");
        mFaceFileNameList.put("[可爱]", "smiley_21");
        mFaceFileNameList.put("[白眼]", "smiley_22");
        mFaceFileNameList.put("[傲慢]", "smiley_23");
        mFaceFileNameList.put("[饥饿]", "smiley_24");
        mFaceFileNameList.put("[困]", "smiley_25");
        mFaceFileNameList.put("[惊恐]", "smiley_26");
        mFaceFileNameList.put("[流汗]", "smiley_27");
        mFaceFileNameList.put("[憨笑]", "smiley_28");
        mFaceFileNameList.put("[大兵]", "smiley_29");
        mFaceFileNameList.put("[奋斗]", "smiley_30");
        mFaceFileNameList.put("[咒骂]", "smiley_31");
        mFaceFileNameList.put("[疑问]", "smiley_32");
        mFaceFileNameList.put("[嘘]", "smiley_33");
        mFaceFileNameList.put("[晕]", "smiley_34");
        mFaceFileNameList.put("[折磨]", "smiley_35");
        mFaceFileNameList.put("[衰]", "smiley_36");
        mFaceFileNameList.put("[骷髅]", "smiley_37");
        mFaceFileNameList.put("[敲打]", "smiley_38");
        mFaceFileNameList.put("[再见]", "smiley_39");
        mFaceFileNameList.put("[擦汗]", "smiley_40");
        mFaceFileNameList.put("[抠鼻]", "smiley_41");
        mFaceFileNameList.put("[鼓掌]", "smiley_42");
        mFaceFileNameList.put("[糗大了]", "smiley_43");
        mFaceFileNameList.put("[坏笑]", "smiley_44");
        mFaceFileNameList.put("[左哼哼]", "smiley_45");
        mFaceFileNameList.put("[右哼哼]", "smiley_46");
        mFaceFileNameList.put("[哈欠]", "smiley_47");
        mFaceFileNameList.put("[鄙视]", "smiley_48");
        mFaceFileNameList.put("[委屈]", "smiley_49");
        mFaceFileNameList.put("[快哭了]", "smiley_50");
        mFaceFileNameList.put("[阴险]", "smiley_51");
        mFaceFileNameList.put("[亲亲]", "smiley_52");
        mFaceFileNameList.put("[吓]", "smiley_53");
        mFaceFileNameList.put("[可怜]", "smiley_54");
        mFaceFileNameList.put("[菜刀]", "smiley_55");
        mFaceFileNameList.put("[西瓜]", "smiley_56");
        mFaceFileNameList.put("[啤酒]", "smiley_57");
        mFaceFileNameList.put("[篮球]", "smiley_58");
        mFaceFileNameList.put("[乒乓]", "smiley_59");
        mFaceFileNameList.put("[咖啡]", "smiley_60");
        mFaceFileNameList.put("[饭]", "smiley_61");
        mFaceFileNameList.put("[猪头]", "smiley_62");
        mFaceFileNameList.put("[玫瑰]", "smiley_63");
        mFaceFileNameList.put("[凋谢]", "smiley_64");
        mFaceFileNameList.put("[示爱]", "smiley_65");
        mFaceFileNameList.put("[爱心]", "smiley_66");
        mFaceFileNameList.put("[心碎]", "smiley_67");
        mFaceFileNameList.put("[蛋糕]", "smiley_68");
        mFaceFileNameList.put("[闪电]", "smiley_69");
        mFaceFileNameList.put("[炸弹]", "smiley_70");
        mFaceFileNameList.put("[刀]", "smiley_71");
        mFaceFileNameList.put("[足球]", "smiley_72");
        mFaceFileNameList.put("[瓢虫]", "smiley_73");
        mFaceFileNameList.put("[便便]", "smiley_74");
        mFaceFileNameList.put("[月亮]", "smiley_75");
        mFaceFileNameList.put("[太阳]", "smiley_76");
        mFaceFileNameList.put("[礼物]", "smiley_77");
        mFaceFileNameList.put("[拥抱]", "smiley_78");
        mFaceFileNameList.put("[强]", "smiley_79");
        mFaceFileNameList.put("[弱]", "smiley_80");
        mFaceFileNameList.put("[握手]", "smiley_81");
        mFaceFileNameList.put("[胜利]", "smiley_82");
        mFaceFileNameList.put("[抱拳]", "smiley_83");
        mFaceFileNameList.put("[勾引]", "smiley_84");
        mFaceFileNameList.put("[拳头]", "smiley_85");
        mFaceFileNameList.put("[差劲]", "smiley_86");
        mFaceFileNameList.put("[爱你]", "smiley_87");
        mFaceFileNameList.put("[NO]", "smiley_88");
        mFaceFileNameList.put("[OK]", "smiley_89");
        mFaceFileNameList.put("[爱情]", "smiley_90");
        mFaceFileNameList.put("[飞吻]", "smiley_91");
        mFaceFileNameList.put("[跳跳]", "smiley_92");
        mFaceFileNameList.put("[发抖]", "smiley_93");
        mFaceFileNameList.put("[怄火]", "smiley_94");
        mFaceFileNameList.put("[转圈]", "smiley_95");
        mFaceFileNameList.put("[磕头]", "smiley_96");
        mFaceFileNameList.put("[回头]", "smiley_97");
        mFaceFileNameList.put("[跳绳]", "smiley_98");
        mFaceFileNameList.put("[挥手]", "smiley_99");
        mFaceFileNameList.put("[激动]", "smiley_100");
        mFaceFileNameList.put("[街舞]", "smiley_101");
        mFaceFileNameList.put("[献吻]", "smiley_102");
        mFaceFileNameList.put("[左太极]", "smiley_103");
        mFaceFileNameList.put("[右太极]", "smiley_104");
    ...
    public int getQQfaceResource(CharSequence text) {
        Integer integer = sFaceMap.get(text.toString());
        if (integer == null) {
            return 0;
        }
        return integer;
