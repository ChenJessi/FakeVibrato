...
//    private static volatile IMManagertest instance;
//
...
//
//
//    private IMManagertest() {
//    }
//
//    public static IMManagertest getInstance() {
//        if (instance == null) {
//            synchronized (IMManagertest.class) {
//                if (instance == null) {
//                    instance = new IMManagertest();
//                }
//            }
//        }
//        return instance;
...
//            @Override
//            public void onError(RongIMClient.ErrorCode errorCode) {
//                Log.e(LogTag.IM, "get conversation to top error, msg:" + errorCode.getMessage() + ", code:" + errorCode.getValue());
//                result.setValue(Resource.error(RongIMClient.ErrorCode.IM_ERROR.getCode(), !isTop));
//            }
//        });
//
//        return result;
...
//        MyLog.d("ss_register_message : initMessageAndTemplate");
