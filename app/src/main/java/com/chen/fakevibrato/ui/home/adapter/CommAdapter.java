 ...
 */
public class CommAdapter extends BaseExpandableRecyclerViewAdapter<CommentBean, CommentChildBean,
        CommAdapter.GroupViewHolder, CommAdapter.ChildViewHolder> {
