...
import com.chen.camerautils.camera.CameraThreadPool;
import com.chen.camerautils.camera.CameraView;
import com.chen.camerautils.camera.ICameraControl;
import com.chen.camerautils.camera.MaskView;
import com.chen.camerautils.camera.CameraLayout;
import com.chen.camerautils.camera.PermissionCallback;
import com.chen.camerautils.crop.CropView;
import com.chen.camerautils.crop.FrameOverlayView;
...
public class CameraActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_camera_cx);
    ...
    private void updateFlashMode() {
        ...
        if (flashMode == ICameraControl.FLASH_MODE_TORCH) {
            lightButton.setImageResource(R.drawable.cx_cm_light_on);
        } else {
            lightButton.setImageResource(R.drawable.cx_cm_light_off);
        }
    }
